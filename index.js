...
// Email list
const recipients = [
  { name: "Harshita Tripathi", email: "harshitatripathimds@gmail.com" },
  { name: "Ashfak Is", email: "ashfakis@yahoo.com" },
];
...
const sendEmails = async () => {
  for (const { name, email } of recipients) {
    const jobTitle = "Full Stack Engineer(Pune)";
    const companyName = "SWAN TECHPRO PRIVATE LIMITED";
